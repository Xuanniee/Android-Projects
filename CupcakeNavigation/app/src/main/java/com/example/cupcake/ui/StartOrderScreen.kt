...
fun StartOrderScreen(
    // A List of Pair values, where each Pair consists of 2 Ints
    // First Int is a String Resource ID for Button, Second Int is the actual Quantity being passed
    quantityOptions: List<Pair<Int, Int>>,
    // TODO: add onNextButtonClicked; Takes an Int to pass the Quantity of Cupcakes
    ...
    Column(
        ...
        quantityOptions.forEach { item ->
            SelectQuantityButton(
                // First Int is the String ID
                labelResourceId = item.first,
                // Second Int is Actual Quantity
